    ...
    <header className="absolute inset-x-0 top-0 z-50">
      <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a onClick={() => handleNextPage('/')} className="cursor-pointer -m-1.5 p-1.5">
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a key={item.name} onClick={() => handleNextPage(item.href)} className="cursor-pointer text-sm/6 font-semibold text-gray-900">
              {item.name}
            </a>
          ))}
        </div>
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a onClick={() => handleNextPage('/sign-in')} className="cursor-pointer text-sm/6 font-semibold text-gray-900">
